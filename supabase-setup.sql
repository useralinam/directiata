...
('Let''s Do It, Romania! -- Doers School', 'Program educational premiat la Gala Green Report pentru excelenta in educatia de mediu. Tabara de vara + ateliere sustenabile pe tot parcursul anului. Invata despre ecologie, reciclare si actiune civica.', 'tabere', 'Let''s Do It, Romania!', 'Diverse locatii, Romania', 'Vara 2026', NULL, '14-18 ani', ARRAY['ecologie', 'educatie', 'sustenabilitate', 'natura'], true, NULL, 'https://letsdoitromania.ro/', 'letsdoitromania.ro', 'ușor', 'approved', '2026-02-04'),
